      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
        <div className="md:w-1/3 w-full">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="w-5 rounded-full bg-indigo-100 flex items-center justify-center">
            ...
            <div className="flex items-center gap-2">
              <div className="w-5 rounded-full bg-orange-100 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white max-w-72 hover:scale-105 transition-all cursor-pointer rounded-2xl p-6 hover:shadow-xl duration-300"
            >
